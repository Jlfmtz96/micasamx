import Logo from '../assets/comebi_logo_color.png';
import { Link } from "react-scroll";
import Maga from '../assets/logo-magadev.png';
import './magadev.css';

export const Footer = () => {
  return (
    <footer className="mt-10 lg:mt-40 text-center p-5 text-gray-500">
        <div className="mb-10">
            <img src={Logo} alt="" className="w-auto h-24 mx-auto" />
        </div>
        ...
        <nav className="flex items-center justify-center space-x-4 mt-10">
            <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95"/></svg></a>
        ...
        <div className="mt-10">
            Copyright &copy; MICASAMX 2023 - Todos los derechos reservados
        </div>
        <div>
            <img src={Maga} alt="" className="w-auto h-12 mx-auto" />
        </div>
    </footer>
  );
}